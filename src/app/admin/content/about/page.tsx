...
export default function AboutCmsEditor() {
  ...
  const handleAddBlock = async (type: string) => {
    ...
    try {
      const res = await createContentBlock({
        ...
        blockType: type,
        sortOrder: newOrder,
        heading: 'New About Section',
        body: 'Custom text details supporting arborist operations or history.',
        alignment: 'left',
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">About Page Blocks CMS</h1>
